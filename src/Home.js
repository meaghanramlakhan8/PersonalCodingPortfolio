...
export default function Home(){
 ...
 const[history,setHistory]=useState([{command:'help',output:'Commands: whoami · skills · projects · resume · contact · clear · sudo hire me · (some commands are undocumented)'}]);

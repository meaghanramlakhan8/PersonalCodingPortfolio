    ...
    <div className="about-container">
      ...
      <section className="about-section">
        <div className="about-card">
          ...
          <p>
            During my time at Rice, I've actively engaged in leadership roles, including serving as the Brown College Associate Recording Justice and mentoring high school students through Rice Women in STEM (WiS). I'm also involved in the Rice International Students’ Association and a current Public Relations board member for Rice's largest annual hackathon HackRice14.
          </p>
        </div>
        <div className="about-card">
          <h2>02</h2>
        ...
        <div className="about-card">
          ...
          <p>
            Outside of tech, you'll find me savoring a good cup of coffee, enjoying live music, or embarking on adventures to explore Houston with my friends. Let's connect and see how we can create something extraordinary together!
          </p>
        </div>
      </section>
    </div>

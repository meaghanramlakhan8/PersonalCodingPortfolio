    ...
    <div className="about-container">
      ...
      <section className="about-section">
        <div className="about-card">
          ...
          <h3>My Journey</h3>
          <p>
            I am currently pursuing a BS in Computer Science with minors in Data Science and Statistics at Rice University, maintaining a GPA of 3.8. Originally from the vibrant and culturally rich Trinidad and Tobago, my academic journey has been fueled by a passion for technology and a commitment to excellence.
          </p>
          <p>
            During my time at Rice, I've actively engaged in leadership roles, including serving as the Brown College Associate Recording Justice and mentoring high school students through Rice Women in STEM (WiS). I'm also involved in the Rice International Students’ Association.
          </p>
        </div>
        <div className="about-card">
          <h2>02</h2>
        ...
        <div className="about-card">
          ...
          <p>
            Outside of tech, you'll find me savoring a good cup of coffee, enjoying live music, or embarking on spontaneous road trips. Let's connect and see how we can create something extraordinary together!
          </p>
        </div>
      </section>
    </div>
